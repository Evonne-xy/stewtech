...
jQuery(document).ready(function () {
    ...
    burger_companion_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Onsoft_Slider').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Onsoft_Slider').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Onsoft_Slider').val())+1;
         jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Onsoft_Slider').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Onsoft_Service').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Onsoft_Service').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Onsoft_Service').val())+1;
         jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Onsoft_Service').val(new_service_add_val);  
        }
        }
        ...
        {
        if(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Onsoft_Social').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Onsoft_Social').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Onsoft_Social').val())+1;
         jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Onsoft_Social').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Desi")
        {
        if(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Onsoft_Design').val()>=8)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Onsoft_Design').val()<8)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Onsoft_Design').val())+1;
         jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Onsoft_Design').val(new_service_add_val);  
        }
        }
    ...
    burger_companion_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Onsoft_Slider').val(parseInt(jQuery('#exist_burger_companion_Spintech_Slider,#exist_burger_companion_ITpress_Slider,#exist_burger_companion_Onsoft_Slider').val())-1);  
                }
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Onsoft_Service').val(parseInt(jQuery('#exist_burger_companion_Spintech_Service,#exist_burger_companion_ITpress_Service,#exist_burger_companion_Onsoft_Service').val())-1);  
                }
                ...
                {
                jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Onsoft_Social').val(parseInt(jQuery('#exist_burger_companion_Spintech_Social,#exist_burger_companion_ITpress_Social,#exist_burger_companion_Onsoft_Social').val())-1); 
                }
				if(split_delete_button_split=="Delete Desig")
                {
                jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Onsoft_Design').val(parseInt(jQuery('#exist_burger_companion_Spintech_Design,#exist_burger_companion_ITpress_Design,#exist_burger_companion_Onsoft_Design').val())-1); 
                }
